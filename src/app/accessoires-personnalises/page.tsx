...
export default function AccessoiresPage() {
  const categories = [
    {
      title: 'Bougies',
      href: '/accessoires-personnalises/bougies',
    ...
    },
    {
      ...
      href: '/accessoires-personnalises/certificats-mariage',

...
export default function AccessoiresPage() {
  const categories = [
    {
      title: 'Bougies',
      href: '/services/accessoires-personnalises/bougies',
    ...
    },
    {
      ...
      href: '/services/accessoires-personnalises/certificats-mariage',

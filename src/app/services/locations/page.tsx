        ...
        <div className="relative h-full flex items-center justify-center">
          <div className="container mx-auto px-6 md:px-12 lg:px-16">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              <h1
                className="text-4xl md:text-5xl lg:text-6xl font-semibold text-white tracking-[0.2em] uppercase animate-fade-in-up"
              >
                LOCATIONS
              </h1>
              <p className="text-base md:text-lg text-white/90 font-light tracking-wide animate-fade-in-up delay-200">
                Découvrez nos collections pour sublimer vos événements
              </p>
            </div>
          </div>
        </div>

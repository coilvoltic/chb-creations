            ...
            <div className="max-w-2xl mx-auto space-y-8">
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-stone-200 p-8 md:p-12">
                ...
                <button
                  ...
                  className="w-full bg-white border-2 border-stone-300 hover:border-black text-black font-medium py-4 px-6 rounded-xl transition-all flex items-center justify-center gap-3 group"
                >

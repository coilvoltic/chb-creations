    ...
    <footer className="bg-stone-100 text-stone-700 border-t border-stone-200">
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-stone-900 text-xl font-semibold mb-4 font-cinzel">CHB Créations</h3>
          ...
          {/* Social Media */}
          <div>
            <h3 className="text-stone-900 text-lg font-semibold mb-4">Suivez-nous</h3>
            <div className="flex gap-4">
              {/* Instagram */}
              <a
                href="https://www.instagram.com/chb.creations/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-stone-200 hover:bg-stone-300 flex items-center justify-center transition-colors group"
                aria-label="Instagram"
              >
                <svg
                  className="w-5 h-5 text-stone-700 group-hover:text-stone-900"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              {/* TikTok */}
              <a
                href="https://www.tiktok.com/@chbcreations"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-stone-200 hover:bg-stone-300 flex items-center justify-center transition-colors group"
                aria-label="TikTok"

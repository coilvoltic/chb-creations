...
function EventCard({ event, onClick, onTagClick }: EventCardProps) {
  ...
  return (
    <div className="relative group">
      ...
      {/* Bouton tag pour gérer les tags */}
      <button
        onClick={handleTagClick}
        className="absolute top-1 right-1 w-6 h-6 bg-white border border-stone-300 rounded-md shadow-sm hover:bg-stone-50 hover:border-stone-400 transition-all flex items-center justify-center"
        title="Gérer les tags"
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 text-stone-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
